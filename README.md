The current project is from THE ODIN PROJECT called Recipes.
Goal of this project is to creat a repository via Git
once created we clone our repository to our local machine and the
cd into the project foler using Git commands

Strickly using basic HTML to create a basic recipe website:
